...
GoCamping is fully functional NodeJs web app
...
With GoCamping, one can create and view data related to botcamps you know, including a picture of the bootcamp.
...
1. [download](https://github.com/Hiten1928/GoCamping/archive/master.zip) the project or clone it to your computer by running `git clone https://github.com/Hiten1928/GoCamping.git` on your Git terminal.
2. In the directory of the folder `gocamping` containing the files of the repositiory, open up the terminal and run `npm install`
...
- **Hiten Gupta** - _Initial work_ - [PurpleBooth](https://github.com/PurpleBooth) -->
